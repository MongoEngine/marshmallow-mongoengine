...
from marshmallow_mongoengine import ModelSchema, field_for, fields, fields_for_model
...
def models():
    ...
    class Student(me.Document):
        ...
        date_created = me.DateTimeField(
            default=dt.datetime.utcnow, help_text="date the student was created"
        )
...
class TestModelSchema(BaseTest):
    ...
    def school(self, models):
        ...
        school_ = models.School(name="Univ. Of Whales", headteacher=headteacher).save()
        return school_
    ...
    def student(self, models, school):
        student_ = models.Student(
            ...
            profile_uri="http://www.imdb.com/name/nm0000416/",
        ).save()
        return student_
    ...
    def course(self, models, student):
        course = models.Course(
            ...
            prereqs={
                ...
                "teachers": {"main": "Mrs. Kensington", "assistant": "Mr. Black"},
            },
    ...
    def test_model_schema_bad_loading(self, models, schemas, school):
        ...
        for key, value, error in (
            (
                "current_school",
                "not an objectId",
                ["unknown document School `not an objectId`"],
            ),
            ("current_school", None, ["Field may not be null."]),
            (
                "current_school",
                "5578726b7a58012298a5a7e2",
                ["unknown document School `5578726b7a58012298a5a7e2`"],
            ),
            (
                "age",
                100,
                ["Must be greater than or equal to 10 and less than or equal to 99."],
            ),
