...
class TestParams(BaseTest):
    def test_required(self):
        ...
        assert excinfo.value.args[0] == {
            "field_required": ["Missing data for required field."]
        }
    ...
    def test_default(self):
        ...
        class Doc(me.Document):
            ...
            field_required_with_default = me.StringField(
                required=True, default=generate_default_value
            )
        ...
        doc = DocSchema().load(
            {
                "field_with_default": "custom_value",
    ...
    def test_regex(self):
        ...
        assert excinfo.value.args[0] == {
            "basic": ["String does not match expected pattern."]
        }
